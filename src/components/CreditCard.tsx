    ...
    <div className="p-8 rounded-[20px] h-64 shadow-lg hover:shadow-xl transition-shadow text-white overflow-hidden" 
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="space-y-6">
          <div>
            <p className="text-base text-white/80">Current Balance</p>
          ...
          <div className="flex justify-between items-end">
            ...
            <div className="text-right">
              ...
              <p className="text-lg font-medium tracking-wider">{cardNumber}</p>
            </div>
          </div>
        </div>
      </div>
...
export const CreditCard = ({
  ...
  return (
    <div className="p-8 pt-8 pb-0 rounded-[20px] h-64 shadow-lg hover:shadow-xl transition-shadow text-white overflow-hidden" style={{ background: 'linear-gradient(107deg, #4C49ED 0%, #0A06F4 100%)' }}>
      <div className="flex flex-col h-full">
        <div className="space-y-1">
          <p className="text-base text-white/80">Balance</p>
        ...
        <div className="space-y-6 mt-auto">
          ...
          <div className="flex justify-between items-center bg-white/10 -mx-8 px-8 py-4 mt-4">
            <p className="text-2xl tracking-wider">{cardNumber}</p>
...
export const CreditCardBack = ({
  ...
  <div className="flex flex-col h-full">
        <div className="space-y-1">
          <p className="text-base text-black/60">Balance</p>
          <div className="flex justify-between items-start">
            <p className="text-4xl font-semibold">${balance.toLocaleString()}</p>
            <div className="w-12 h-8 flex items-center justify-center">
